...
Таким образом, убеждаемся в возможности управления собственной базой vlan на коммутаторе (vlan 2000) и одновременной работе по передаче объявлений VTP (vlans 10,20,30,99).
